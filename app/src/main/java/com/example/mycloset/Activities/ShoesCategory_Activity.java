...
import static com.example.mycloset.Models.Finals.SHOES;
...
public class ShoesCategory_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= database.getReference(user.getUid()).child(SHOES);
        getImageData();
    ...
    private void uploadImage() {
        ...
        if (uriImage != null) {
            ...
            StorageReference AccessoriesRef = storageRef.child(user.getUid()).child(SHOES).child(randomKey + ".jpg");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (ds.getValue().equals(listPicture.getImageUrl())){
                        ...
                        storageRef.child(user.getUid()).child(SHOES).child(key + ".jpg").delete();
