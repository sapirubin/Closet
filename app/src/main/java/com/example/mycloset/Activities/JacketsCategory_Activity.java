...
import static com.example.mycloset.Models.Finals.JACKETS;
...
public class JacketsCategory_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= database.getReference(user.getUid()).child(JACKETS);
        getImageData();
    ...
    private void uploadImage() {
        ...
        if (uriImage != null) {
            ...
            StorageReference AccessoriesRef = storageRef.child(user.getUid()).child(JACKETS).child(randomKey + ".jpg");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (ds.getValue().equals(listPicture.getImageUrl())){
                        ...
                        storageRef.child(user.getUid()).child(JACKETS).child(key + ".jpg").delete();
