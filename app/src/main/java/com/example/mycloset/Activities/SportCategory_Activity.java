...
import static com.example.mycloset.Models.Finals.SPORT;

public class SportCategory_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= database.getReference(user.getUid()).child(SPORT);
        getImageData();
    ...
    private void uploadImage() {
        ...
        if (uriImage != null) {
            ...
            StorageReference AccessoriesRef = storageRef.child(user.getUid()).child(SPORT).child(randomKey + ".jpg");
